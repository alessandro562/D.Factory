...
Il piede porta la riga di dichiarazione e il numero, niente altro. Il marchio
compare due volte in tutto il documento — copertina e chiusura — e non a ogni
piede: ripeterlo è un'abitudine da slide.
...
**Manca:** il marchio originale. Lo spazio in testa alla pagina è riservato in
altezza e vuoto; la working edition lo dichiara con una casella tratteggiata.
**Non dice:** chi lo manda. Quello sta in chiusura.

### 02 · Come si legge — sezione 0
Quattro percorsi da tre pagine, l'elenco dei quattro annessi con il
...
La definizione del prodotto, tre principi (brownfield first,
...
Le cinque stazioni della catena funzionale, con la decisione marcata
...
La vista di linea ricostruita: tre macchine sul turno, i fermi già
...
Tre famiglie di analisi, e il report di periodo come
...
### 07 · Refyn — sezione 1
Le tre fasi del ciclo in colonne — priorità, azioni, verifica — e i
...
Quattordici capacità su sette aree, con Connect, Insight
...
Cinque sorgenti con quello che forniscono e dove stanno. La fascia
...
I nove attributi di ogni evento in griglia, con la causa
...
La pila dei quattro livelli logici, dal basso verso l'alto, con la
...
Nove aree con il modello che il prodotto mette a disposizione.
...
La scomposizione di un turno a quattro gradini con la capacità
...
Sette parametri con la loro provenienza, il turno in tre
...
Tre output del prodotto e due interfacce verso sistemi
...
Le sei fasi con che cosa fanno e il deliverable che producono, la
...
Nove servizi raggruppati per momento — avvio, esercizio, estensione
...
### 18 · Chiusura — scura
Marchio — stesso spazio riservato della copertina — filetto giallo, «Il passo
successivo è un audit sull'impianto reale», e i tre passaggi con gli annessi che
si compilano lungo la strada.
...
## 4 · Che cosa è stato tolto, e perché

| tolto | ragione |
|---|---|
| la riga di scrematura in testa a ogni pagina — tassello di ruolo più frase di sintesi | diceva quello che il titolo già dice, e lo diceva con la voce di un sistema che classifica invece che di una persona che scrive |
| il wordmark «D.Factory» ricomposto in HTML nel piede di 22 pagine | un marchio si incorpora, non si ricompone; e non va a ogni piede |

I quattro percorsi di lettura restano, ma vivono a pagina 02: dichiarati una
volta sola, dove si va a cercarli.

---

## 5 · Le formulazioni vincolate
...
## 6 · Il rapporto con il Sales Deck V9.3
